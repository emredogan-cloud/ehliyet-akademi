...
describe('dedupReport', () => {
  it('yeniden ifade edilmiş yakın-yinelemeyi yakalar, farklıyı yakalamaz', () => {
    const pool = [
      ...
      nq({
        ...
        options: ['30 kilometre', '50 kilometre', '70 kilometre', '90 kilometre'],
        answerIndex: 1,
        explanation:
      ...
      nq({
        ...
        options: ['Yara üzerine', 'Karın', 'Ayak', 'Boyun'],
        answerIndex: 0,
  ...
  it('özdeş içeriği (farklı id) tam yineleme sayar', () => {
    const base = {
      ...
      options: ['El frenini kademeli çek', 'Gaza bas', 'Kontağı kapat', 'Vitesi boşa al'],
      answerIndex: 0,
