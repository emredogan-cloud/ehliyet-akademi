        ...
        child: ListView(
          ...
          children: [
            ...
            HubRow(
              ...
              color: p.purple,
              title: 'Sınav Arşivi',
              subtitle: 'Kategori ve tarihe göre, her biri özgün üretilen denemeler',
              onTap: () => context.push('/practice/library'),
            ),
            const SizedBox(height: AppSpacing.s3),
            HubRow(
              ...
              color: p.accent,
              title: 'Düello',
              subtitle: 'Soru başına 20 saniye — rakibe karşı 10 soruluk hızlı sınama',
              onTap: () => context.push('/practice/duel'),
            ),
          ],
        ),
      ),
